...
module Admin
  class TenantsController < Admin::ApplicationController
    ...
    def tenant_params
      params.require(:tenant).permit(:name, :nid, :email, :mobile, :peraddrline1, :peraddrline2, :peraddrline3,
                                     :zipcode, :city, :country, :entrydate, :exitdate, :rentpermonth, :advancepaid, :status, :property_id, :unit_id)
    end
  end
end
